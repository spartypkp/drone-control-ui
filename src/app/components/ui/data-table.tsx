...
export function DataTable<TData, TValue>({
	...
	return (
		<Card className="max-h-full">
			...
			<CardContent className="max-h-full flex-grow overflow-hidden" >
...
const getTitleAndDescription = (status: string) => {
	switch (status) {
		...
		case 'first_order_question':
			return {
				title: 'First Order Questions',
				description: 'View groups of citations that require a first order question.'
			};
		default:
			return {
				title: 'Citations',
